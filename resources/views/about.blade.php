...
@section('content')
    ...
    <section class="container mx-auto  ">
        <div class=" py-4 lg:py-10 flex flex-col items-center">
            <h2 class="text-[38px] text-center lg:text-[64px] leading-[44px] lg:leading-[82px] font-medium max-w-4xl" data-aos="fade-down" data-aos-duration="2000">
        ...
        <img src="{{ asset('img/about/aboutus.png') }}" class="mx-auto py-4" data-aos="zoom-in" data-aos-duration="2000" alt="">
    </section>
    ...
    <section class="container mx-auto grid grid-cols-2 py-7 lg:py-[100px] gap-10">
        ...
        <div class="col-span-2 lg:col-span-1 p-[50px] rounded-3xl order-1 lg:order-2" data-aos="fade-left" data-aos-duration="2000"
    ...
    <section class=" lg:p-20 py-16 flex flex-col lg:flex-row justify-center items-center lg:space-x-10 mb-6" style="background-image: url('{{asset('img/about/bgdes.png')}}')">
        <div class="lg:ml-36" data-aos="fade-right" data-aos-duration="2000">
            <div class=" bg-white h-40 w-40 rounded-full flex items-center justify-center">
                <img src="{{asset('img/logo.png')}}" class=" h-12" alt="">
            </div>
        </div>
        <div class="text-white pt-3 lg:pt-0 text-center lg:text-left px-2" data-aos="fade-left" data-aos-duration="2000">
    ...
    <section class=" container mx-auto pt-6 lg:pt-20">
        <div class=" items-center">
            <h2 class="text-center text-[38px] leading-[44px] lg:text-[64px] lg:leading-[82px] font-medium" data-aos="fade-down" data-aos-duration="2000">Life at
                Commentjet</h2>
            <p class="text-[18px] lg:text-[22px] leading-6 lg:leading-9 text-center py-2 lg:py-0">San Diego HQ, United
                States, Canada, Ireland, United Kingdom, Australia, and across the globe.</p>
        ...
        <img src="{{ asset('img/about/Life at Commentjet.png') }}" data-aos="zoom-in" data-aos-duration="2000" alt="">
    </section>
