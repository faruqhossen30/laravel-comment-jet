    ...
    <section class="container mx-auto">
        ...
        <div class="bg-[#E4E2DF] p-4 lg:p-[80px] rounded-3xl">
            <div class=" text-center pb-4">
                <h4 class="text-[18px] lg:text-[22px] leading-6 lg:leading-9" data-aos="fade-down" data-aos-duration="2000">Contact Us</h4>
                <h2 class=" py-2 text-[38px] lg:text-[64px] leading-[44px] lg:leading-[82px]" data-aos="fade-down" data-aos-duration="2000">Submit a request</h2>
            ...
            <form class="mx-auto">
                <div class="grid grid-cols-2 gap-8">
                    <div class="col-span-2 lg:col-span-1 relative z-0 w-full mb-2 lg:mb-10 group" data-aos="fade-right" data-aos-duration="2000">
                    ...
                    <div class="col-span-2 lg:col-span-1 relative z-0 w-full mb-10 group" data-aos="fade-left" data-aos-duration="2000">
                ...
                <div class="relative z-0 w-full mb-5 group" data-aos="fade-right" data-aos-duration="2000">
                ...
                <div class="flex space-x-4 items-center mb-10" data-aos="fade-up" data-aos-duration="2000">
                ...
                <p class="text-[15px] leading-6 lg:leading-9 py-2" data-aos="fade-up" data-aos-duration="2000">Please enter the details of your request. A member of our support staff will respond as soon as possible.</p>


                <button type="submit" data-aos="fade-up" data-aos-duration="2000"
