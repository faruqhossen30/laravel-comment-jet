...
@section('content')
    <div class="flex flex-col items-center container mx-auto lg:py-6 lg:mt-4">
        ...
        <h2 class="heading-two text-center py-10 max-w-4xl">Fastest way to design and complete
            your project</h2>
    ...
    <section class="container mx-auto text-center py-[73px] lg:py-[120px]">
        <h2 class="heading-two max-w-4xl text-center inline-block">Unlock efficiency and
    ...
    <div class="grid grid-cols-2 items-center gap-32 container mx-auto">
        <div class="col-span-2 lg:col-span-1 p-6 rounded-3xl" style="background: rgba(222, 220, 216, 1);">
            <img src="{{ asset('img/share-member.png') }}" class="p-6 w-full" style="background: rgba(222, 220, 216, 1);"
                alt="">
        </div>
    ...
    <section style="background-image:url('{{ asset('img/giggag.png') }}')">
    ...
    <section class="bg-[#565656] mt-40">
        <div style="background-image: url('{{ asset('img/giggag.png') }}')">
            <div class="container mx-auto">
