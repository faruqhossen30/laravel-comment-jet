                                ...
                                <div for="dropzone-file" id="dropZoneArea"
                                    ...
                                    @if (auth()->user()->thumbnail)
                                        <div class="relative group">
                                            ...
                                            <input type="hidden" name="thumbnail" value="{{ $profile->thumbnail }}">
                                            <img class="max-h-60 w-auto rounded-full p-4"
                                                src="{{ asset('uploads/galleries/' . $profile->thumbnail) }}" alt="thumbnail">
                                        </div>
                                    @else
                        ...
                        <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                            <div class="justify-center">
                                ...
                                <div class="grid grid-cols-5 px-1 py-1  mt-5">
                                    ...
                                    <p class="col-span-3">{{ $profile->name }}</p>
                                </div>
                                <div class="grid grid-cols-5 px-1 py-1  mt-5">
                ...
                <div class="col-span-2">
                    <div
                        ...
                        <div class="flex justify-between">
                            <div>
                                <h3 class="mb-4 text-xl font-semibold dark:text-white">Genaral information !!!</h3>
                            </div>
                            <div>
                              <a href="{{route('admin.profile.resetpassword',$profile->id)}}" class="py-1 my-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800">Reset Password</a>
                            </div>
                        </div>

                        <x-form.input label="Name" name="name" value="{{ $profile->name }}" />
