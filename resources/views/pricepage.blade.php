...
@section('content')
    <section class="py-6">
        <h2 class="text-6xl leading-[82px] text-center font-medium"> The digital content<br>solution, for the best price.
        </h2>
    ...
    <section class="container mx-auto">
        <div class="grid grid-cols-12 gap-3">
            <div class="col-span-6 bg-[#E4E2DF] p-10 rounded-lg">
            ...
            <div class="col-span-6 bg-[#9FE870] p-10 rounded-lg">
    ...
    <section class="container mx-auto mt-32 ">
        <h3 class="text-6xl leading-[82px] text-center font-medium my-4	">See full feature matrix</h3>
        <hr class="h-px my-6 bg-gray-400 border-0 dark:bg-gray-700">
        <table class="w-full  ">
            <thead>
                <tr class="text-left text-[28px] leading-9 font-medium">
                    <th>Key features</th>
                    <th>Professionals</th>
                    <th>Unlimited</th>
                </tr>
            ...
            <tbody>
                <tr class=" text-[22px] leading-9 font-normal">
    ...
    <section class="bg-[#565656] mt-40">
        <div class="container mx-auto">
            <div class=" text-center py-10">
                <h2 class="font-semibold text-[64px] leading-[82px] text-white">Start using commentjet for <span class="text-[#9FE870]">free</span>
                </h2>
